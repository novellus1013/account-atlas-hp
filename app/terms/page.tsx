      ...
      <main className="py-16 sm:py-20">
        <article className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-neutral mt-10 max-w-none">
            ...
            {/* 상표권 면책 조항 추가 섹션 */}
            <section className="mb-10">
              <h2 className="text-xl font-semibold text-foreground">Trademark Disclaimer</h2>
              <p className="mt-3 leading-relaxed text-muted-foreground">
                All logos and trademarks displayed in this app are the property of their respective owners. {siteConfig.appName} is not affiliated with, endorsed by, or sponsored by any of the service providers shown.
              </p>
            </section>
